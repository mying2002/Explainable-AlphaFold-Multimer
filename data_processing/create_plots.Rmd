...
```{r import data}
# import raw data
source_processed_monomer_output = read.csv("deletion_perturb_out/processed_monomer_output.csv")
source_processed_multimer_output = read.csv("deletion_perturb_out/processed_multimer_output.csv")

source_processed_AA_monomer_output = read.csv("deletion_perturb_out/processed_AA_monomer_output.csv")
source_processed_AA_multimer_output = read.csv("deletion_perturb_out/processed_AA_multimer_output.csv")
```
...
# - save image - #
# ggsave(plot = g_delta_corrs, width = 9, height = 6, dpi = 300, filename = "plots/within_metric_delta_corrs.png")
...
# - save - #
# ggsave(plot = g_cross_delta_corrs, width = 9, height = 6, dpi = 300, filename = "plots/cross_metric_delta_corrs.png")
...
save_heat_map = function(plot_complex_id, is_AA) {
  ...
  # - save - #
  # plot_file_name = paste0("plots/", plot_complex_id, "_delta_scores.png")
  
  if (is_AA) {
    plot_file_name = paste0("plots/AA/", plot_complex_id, "_delta_scores.png")
  } else {
    plot_file_name = paste0("plots/non_AA/", plot_complex_id, "_delta_scores.png")
  }
